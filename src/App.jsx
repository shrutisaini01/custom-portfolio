  ...
  const projects = [
    {
      ...
      desc: 'A feature-rich travel planning application with an immersive 3D globe interface. Users can search and explore destinations, get detailed travel insights including famous food, weather, and local attractions, set travel budgets, and choose trip durations. Integrated hotel booking, interactive maps, and AI-powered suggestions enhance user experience.',
      link: 'https://github.com/Akarsh-2004/Bagragi'
    },
    {
      title: 'OA Generator',
      ...
      link: 'https://github.com/shrutisaini01/OA-Generator'
    },
    {
      title: 'DhanSakhi',
      desc: 'An AI-powered financial advisor web app that supports multilingual voice interaction, budget tracking, and financial education through intuitive visuals. Uses speech recognition, text-to-speech, and personalized assistance. Shortlisted for EY Techathon 5.0 for its innovation and accessibility.',
      link: 'https://dhan-sakhi.onrender.com/'
    },
    {
      title: 'SmartCart',
      desc: 'An IoT-based smart shopping cart with real-time billing, RFID-based item detection, and interactive display. Enhances customer convenience by eliminating checkout lines, integrating product suggestions, and delivering a seamless shopping experience.',
    ...
    },
    {
      ...
      desc: 'A foundational x86-based OS written in Assembly and C. Features include a custom bootloader, kernel, basic shell, and low-level memory operations. Runs in QEMU emulator, showcasing deep understanding of hardware-software interface and OS design principles.',
    ...
    <div className={darkMode ? 'bg-gray-900 text-white transition duration-500' : 'bg-white text-gray-900 transition duration-500'}>
      ...
      <section id="experience" className="py-20 px-6 max-w-5xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          >
            <h3 className="text-2xl font-semibold">Salesforce Developer Intern – Salesforce</h3>
            <p className="text-sm text-gray-500 mb-2">June 2025 – Present (Remote)</p>
          ...
          <motion.div 
            ...
            whileHover={{ scale: 1.02 }}
          >
            <h3 className="text-2xl font-semibold">WordPress Developer Intern – GaoTek Inc.</h3>
            <p className="text-sm text-gray-500 mb-2">July 2024 – Nov 2024 (Remote)</p>
            <p className="text-base text-gray-700 dark:text-gray-300">
          ...
          <motion.div 
            ...
            whileHover={{ scale: 1.02 }}
          >
            <h3 className="text-2xl font-semibold">Interview Experience</h3>
            <p className="text-base text-gray-700 dark:text-gray-300">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((proj, i) => (
            <motion.a
              ...
              className="block bg-gray-100 dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300"
